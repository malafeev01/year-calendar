      ...
      <div className="privacy-page">
        ...
        <div className="privacy-page-landing-row">
          ...
          <div className="privacy-page-paragraph">
            ...
            <br />
            When you log in to the system, you will receive an access token.
            This token will be saved in the cookies of your browser.
            <br />
            Token is not stored on the server side!
            <br />
            <br />
            After you got the token, it will be used for access to Calendar API
            of your Google Account. <br />
            What is our server part role here? It just resends requests to
            Google Calendar API.
            <br />
            ...
            <a href="https://github.com/malafeev01/yearplan.app.backend">
              link
            </a>
            ].
          </div>
          ...
          <div className="privacy-page-paragraph">
            ...
            YearPlan.app is not using any analytics systems. Frontend part of
            the application is available in GitHub - [
